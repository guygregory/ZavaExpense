...
| Category | Default Payment Method |
|----------|------------------------|
| Gift | Cash |
| Hardware | Cash |
| Hotel | Cash |
...
| Business purpose | Natural language description | Generate from receipt + WorkIQ calendar context |
...
### Step 2: Open or Create Current Month's Expense Report
...
2. **Close the browser** using Playwright MCP
3. Inform the user that all expenses have been added and the browser has been closed
